...
const SettingModal: React.FC<settingModalinterface> = ({ setsettingIsVisible, settingisVisible,setActiveContent }) => {
  ...
  const handleSignout = async () =>  {
    ...
    useEffect(() => {
        // No language logic needed
    }, []); // Empty array ensures this runs once on mount

    // const handleSwitch = (event: React.ChangeEvent<HTMLInputElement>) => { // This function is removed as per the edit hint
    ...
    // const MaterialUISwitch = styled(Switch)(({ }) => ({ // This component is removed as per the edit hint
    //     width: 50,
    //     height: 28,
    //     padding: 7,
